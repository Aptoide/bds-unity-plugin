...
public class ExportPackageAutomatically : ScriptableObject
{
    ...
    public static void ExportFromUnity()
    {
        ...
        List<string> foldersToRemove = new List<string> {
            ...
            ,"Assets/Plugins/UnityPurchasing/Editor"
            ,"Assets/Plugins/UnityPurchasing/Bin/Apple"
            ,"Assets/Plugins/UnityPurchasing/Bin/Facebook"
            ,"Assets/Plugins/UnityPurchasing/Bin/Tizen"
            ,"Assets/Plugins/UnityPurchasing/Icons"
            ,"Assets/Plugins/UnityPurchasing/iOS"
            ,"Assets/Plugins/UnityPurchasing/Resources"
            ,"Assets/Plugins/UnityPurchasing/scenes"
            ,"Assets/Plugins/UnityPurchasing/script"
            ,"Assets/Plugins/UnityPurchasing/winrt"
            ,"Assets/Scenes"
        };
